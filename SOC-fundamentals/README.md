...
This folder documents my understanding of Security Operations Center (SOC) concepts,
analyst roles, and the blue team mindset required for real-world security operations.

All notes are written in my own words after watching and understanding each topic —
not copy-pasted. This ensures genuine understanding over memorization.
...
> 💡 Each file in this folder connects directly to real SOC workflows.
> Understanding these concepts is what separates a reactive analyst from a proactive defender.
